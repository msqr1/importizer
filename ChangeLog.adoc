...
* Build & cache static LibTooling to distribute standalone binaries
* Support Windows ARM64, Linux ARM64, & MacOS amd64
...
* Changed TOML transitional mode to `[transitional]` (was `[Transitional]`) to match the command-line & project naming conventions.
